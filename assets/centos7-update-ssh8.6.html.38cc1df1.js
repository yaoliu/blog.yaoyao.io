...
</code></pre></div><p><strong>\u5B89\u88C5 RPM \u7F16\u8BD1\u5DE5\u5177\u53CA\u76F8\u5173\u4F9D\u8D56\u5305</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> rpm-build zlib-devel openssl-devel gcc perl-devel pam-devel
...
<span class="token function">mkdir</span> <span class="token parameter variable">-p</span> rpmbuild/<span class="token punctuation">{</span>SOURCES,SPECS,RPMS,SRPMS,BUILD,BUILDROOT<span class="token punctuation">}</span>
...
<span class="token function">tar</span> <span class="token parameter variable">-zxf</span> /root/openssh-8.6p1.tar.gz <span class="token parameter variable">-C</span> /opt/
// \u4F9D\u8D56\u6587\u4EF6
...
<span class="token parameter variable">-auth</span>      optional     pam_reauthorize.so prepare
...
<span class="token comment"># Used with polkit to reauthorize users in remote sessions</span>
<span class="token parameter variable">-session</span>   optional     pam_reauthorize.so prepare
...
<span class="token function">cp</span> <span class="token parameter variable">-r</span> /etc/ssh/* /root/ssh_bak_<span class="token variable"><span class="token variable">\`</span><span class="token function">date</span> +<span class="token string">&quot;%Y-%m-%d&quot;</span><span class="token variable">\`</span></span>
...
</code></pre></div>`,41),t=[e];function r(c,l){return n(),a("div",null,t)}var i=s(p,[["render",r],["__file","centos7-update-ssh8.6.html.vue"]]);export{i as default};
