...
// \u89E3\u538B\u7F29
<span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> mysql-5.7.35-linux-glibc2.12-x86_64.tar.gz <span class="token parameter variable">-C</span> /usr/local/mysql <span class="token parameter variable">--strip</span><span class="token operator">=</span><span class="token number">1</span>
// \u521B\u5EFA\u7528\u6237\u53CA\u7528\u6237\u7EC4
<span class="token function">groupadd</span> mysql
<span class="token function">useradd</span> mysql <span class="token parameter variable">-g</span> mysql <span class="token parameter variable">-s</span> /sbin/nologin
// \u521B\u5EFA\u6570\u636E\u5E93\u6570\u636E\u76EE\u5F55
...
/usr/local/mysql/bin/mysqld <span class="token parameter variable">--user</span><span class="token operator">=</span>mysql <span class="token parameter variable">--basedir</span><span class="token operator">=</span>/usr/local/mysql/ <span class="token parameter variable">--datadir</span><span class="token operator">=</span>/usr/local/mysql/data <span class="token parameter variable">--initialize</span>
// \u4F1A\u6253\u5370\u4E00\u4E0B\u65E5\u5FD7 \u8BB0\u4F4F\u4FDD\u5B58\u597D\u5BC6\u7801
<span class="token number">2021</span>-09-01T11:54:32.248336Z <span class="token number">0</span> <span class="token punctuation">[</span>Warning<span class="token punctuation">]</span> TIMESTAMP with implicit DEFAULT value is deprecated. Please use <span class="token parameter variable">--explicit_defaults_for_timestamp</span> server option <span class="token punctuation">(</span>see documentation <span class="token keyword">for</span> <span class="token function">more</span> details<span class="token punctuation">)</span>.
...
</code></pre></div><h2 id="\u53C2\u8003\u8D44\u6599" tabindex="-1"><a class="header-anchor" href="#\u53C2\u8003\u8D44\u6599" aria-hidden="true">#</a> \u53C2\u8003\u8D44\u6599</h2><ol><li><a href="https://keithlan.github.io/2016/06/23/gtid/" target="_blank" rel="noopener noreferrer">https://keithlan.github.io/2016/06/23/gtid/</a></li><li><a href="http://mysql.taobao.org/monthly/2020/05/09/" target="_blank" rel="noopener noreferrer">http://mysql.taobao.org/monthly/2020/05/09/</a></li><li><a href="https://bbs.huaweicloud.com/blogs/211180" target="_blank" rel="noopener noreferrer">https://bbs.huaweicloud.com/blogs/211180</a></li></ol>`,43),t=[o];function r(l,c){return n(),a("div",null,t)}var u=s(e,[["render",r],["__file","mysql-2master-gtid.html.vue"]]);export{u as default};
