...
<span class="token assign-left variable">user.max_user_namespaces</span><span class="token operator">=</span><span class="token number">28633</span>
EOF
...
</code></pre></div><p>\u914D\u7F6E <strong>Containerd</strong> \u5F00\u673A\u542F\u52A8\uFF0C\u5E76\u542F\u52A8 <strong>Containerd</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code>systemctl <span class="token builtin class-name">enable</span> containerd <span class="token parameter variable">--now</span>
...
</code></pre></div><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> <span class="token environment constant">$HOME</span>/.kube
...
</code></pre></div><p>\u521D\u59CB\u5316\u6210\u529F\u540E\u4F1A\u751F\u6210\u8282\u70B9\u52A0\u5165\u96C6\u7FA4\u7684\u547D\u4EE4 \u5728\u5176\u4ED6\u8282\u70B9\u4E0A\u6267\u884C\u8BE5\u547D\u4EE4</p><h3 id="\u5728node\u4E0A\u6267\u884C" tabindex="-1"><a class="header-anchor" href="#\u5728node\u4E0A\u6267\u884C" aria-hidden="true">#</a> \u5728node\u4E0A\u6267\u884C</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>kubeadm <span class="token function">join</span> <span class="token number">10.211</span>.55.9:6443 <span class="token parameter variable">--token</span> mldghy.xtf4a0u9bw8ltsvu --discovery-token-ca-cert-hash sha256:2b0f87c543d77e0b8f843db47c95985febe17a19de747b064720097db9b9535c
...
</code></pre></div><p>\u6D89\u53CADNS\u95EE\u9898\u53EF\u4EE5\u8003\u8651\u5173\u6389DNS\u7BA1\u7406\u670D\u52A1</p><p>\u53C2\u8003<a href="https://icloudnative.io/posts/resolvconf-tutorial/" target="_blank" rel="noopener noreferrer">https://icloudnative.io/posts/resolvconf-tutorial/</a></p>`,52),p=[o];function c(l,r){return n(),a("div",null,p)}var u=s(t,[["render",c],["__file","kubeadm-install-k8s.html.vue"]]);export{u as default};
