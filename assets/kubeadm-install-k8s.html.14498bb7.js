...
</code></pre></div><p><strong>\u4FEE\u6539\u5185\u6838\u53C2\u6570 \u521B\u5EFA\u6587\u4EF6\u6DFB\u52A0\u5185\u5BB9</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code>
<span class="token comment"># cat &lt;&lt; EOF &gt; /etc/sysctl.d/99-kubernetes-cri.conf</span>
...
</code></pre></div><p><strong>\u5B89\u88C5\u5BB9\u5668\u8FD0\u884C\u65F6 Containerd \u8FD9\u91CC\u4F7F\u7528\u963F\u91CC\u4E91\u63D0\u4F9B\u7684\u6E90</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code>
<span class="token comment"># // \u6DFB\u52A0\u76F8\u5173\u6E90 \u6211\u5728Macbook\u4E0A\u4F7F\u7528PD\u641E\u7684\u865A\u62DF\u673A \u8FD9\u5730\u65B9\u9700\u8981\u6539\u4E3A\u5BF9\u5E94\u67B6\u6784\u7684 arch=arm64</span>
...
</code></pre></div><p>\u914D\u7F6E <strong>Containerd</strong> \u5F00\u673A\u542F\u52A8\uFF0C\u5E76\u542F\u52A8 <strong>Containerd</strong></p><div class="language-text ext-text"><pre class="language-text"><code>systemctl enable containerd --now
...
</code></pre></div><p><strong>\u90E8\u7F72 Flannel \u7EC4\u4EF6 (Vxlan\u6A21\u5F0F)</strong></p><p>\u4E0B\u8F7D\u914D\u7F6E\u6587\u4EF6</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># wget https://raw.githubusercontent.com/flannel-io/flannel/master/Documentation/kube-flannel.yml</span>
</code></pre></div><p>\u4FEE\u6539\u914D\u7F6E\u6587\u4EF6 \u53EA\u4FEE\u6539Network\u548CBackend Type</p><div class="language-bash ext-sh"><pre class="language-bash"><code>data:
...
</code></pre></div><p>\u6D89\u53CADNS\u95EE\u9898\u53EF\u4EE5\u8003\u8651\u5173\u6389DNS\u7BA1\u7406\u670D\u52A1</p><p>\u53C2\u8003<a href="https://icloudnative.io/posts/resolvconf-tutorial/" target="_blank" rel="noopener noreferrer">\u91CD\u65B0\u593A\u56DE\u5BF9 /etc/resolv.conf \u7684\u63A7\u5236\u6743</a></p>`,51);function t(o,p){return e}var l=n(a,[["render",t],["__file","kubeadm-install-k8s.html.vue"]]);export{l as default};
